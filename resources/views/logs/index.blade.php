      ...
      <div class="col-md-12 col-xl-4">
        <div class="box">
          ...
          <ul class="list no-border">
                <li class="list-item">
                  <a href="" class="pull-left w-40 m-r"><img src="{{ asset('flatkit/assets/images/a1.jpg') }}" class="img-responsive img-circle"></a>
                  <div class="clear">
                ...
                <li class="list-item">
                  <a href="" class="pull-left w-40 m-r"><img src="{{ asset('flatkit/assets/images/a2.jpg') }}" class="img-responsive img-circle"></a>
                  <div class="clear">
                ...
                <li class="list-item">
                  <a href="" class="pull-left w-40 m-r"><img src="{{ asset('flatkit/assets/images/a3.jpg') }}" class="img-responsive img-circle"></a>
                  <div class="clear">
                ...
                <li class="list-item">
                  <a href="" class="pull-left w-40 m-r"><img src="{{ asset('flatkit/assets/images/a4.jpg') }}" class="img-responsive img-circle"></a>
                  <div class="clear">
